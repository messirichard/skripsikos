<section class='content'>
    ...
    <div class='box'>
        ...
        <div class='box-body'>
            ...
            <div class="form-group">
                <label for="int">Laundry Packet <?php echo form_error('laundry_packet_name') ?></label>
...
<script>
    ...
    {
        $.get("http://laundryan.co.id/transactions/get_price/" + id, function (data) {
