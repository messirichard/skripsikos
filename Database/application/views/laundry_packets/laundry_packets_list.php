...
<section class="content">
        ...
        <h2 style="margin-top:0px">Laundry_packets List</h2>
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('laundry_packets/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
		...
		<th>Action</th>
			...
			<td><?php echo $laundry_packets->price ?></td>
